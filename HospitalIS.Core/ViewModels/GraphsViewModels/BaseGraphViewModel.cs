...
namespace HospitalIS.Core.ViewModels.GraphsViewModels
{
    [AddINotifyPropertyChangedInterface]
    public class BaseGraphViewModel : BaseViewModel
    {
        int _labelCount;
        ...
        public BaseGraphViewModel(int labelCount, string xAxisTitle, int gap, int minValue , string propName)
        {
